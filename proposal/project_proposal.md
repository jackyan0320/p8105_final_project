...
-   Compare county wide donor registration rates in New York to see if there are counties that are especially lacking in donor rate. We will map the registration rate on the state map using `ggmap`.
