...
<div class = "plot_description">
  ...
  <h2>Registration Rate 2018 
      <h4  style="margin-left: 70%;"> [Explore Change by Years](https://sijiayue.shinyapps.io/shinny_heatmap/)<a href= "interesting_finding.html"> <i class="fa fa-space-shuttle" aria-hidden="true"></i> </a> <h4> 
  </h2>
...
<div class="slidecontainer">
  <input type="range" min="2008" max="2018" value="2013" class="slider" id="myRange">
  <p>Year: <span id="demo"></span></p>
  <img id="mapImg" src="website_img_maps/2013.png">
</div>
