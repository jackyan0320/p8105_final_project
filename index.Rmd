...
<div class = "plot_description">
  ...
  <h2>Registration Rate 2018 
      <h4  style="margin-left: 60%;"> [Explore Change by Years](interesting_finding.html)<a href= "interesting_finding.html"> <i class="fas fa-exchange-alt"></i> </a> <h4> 
  </h2>

</div>

 <div class = "single_map_plot">
```{r, warning = FALSE, message = FALSE, echo=FALSE, fig.height = 10, fig.width = 22}
# plot part 
p
```
