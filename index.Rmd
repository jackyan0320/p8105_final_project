...
<div class = "plot_description">
  ...
  <h2>Registration Rate 2018 
      <h4  style="margin-left: 70%;"> [Explore Change by Years](https://sijiayue.shinyapps.io/shinny_heatmap/)<a href= "interesting_finding.html"> <i class="fas fa-exchange-alt"></i> </a> <h4> 
  </h2>
